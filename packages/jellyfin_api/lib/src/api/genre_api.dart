...
class GenreApi {
  ...
  const GenreApi(this._dio, this._serializers);
  ...
  Future<Response<BaseItemDto>> getGenre({ 
    ...
    final _path = r'/Genres/{genreName}'.replaceAll('{' r'genreName' '}', encodeQueryParameter(_serializers, genreName, const FullType(String)).toString());
