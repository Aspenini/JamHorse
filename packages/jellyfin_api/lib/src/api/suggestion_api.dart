...
class SuggestionApi {
  ...
  const SuggestionApi(this._dio, this._serializers);
  ...
  Future<Response<BaseItemDtoQueryResult>> getSuggestions({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (mediaType != null) r'mediaType': encodeCollectionQueryParameter<MediaType>(_serializers, mediaType, const FullType(BuiltList, [FullType(MediaType)]), format: ListFormat.multi,),
