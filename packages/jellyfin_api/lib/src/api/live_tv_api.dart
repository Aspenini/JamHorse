...
class LiveTvApi {
  ...
  Future<Response<ListingsProviderInfo>> addListingProvider({ 
    ...
    try {
      ...
      _bodyData = listingsProviderInfo == null ? null : _serializers.serialize(listingsProviderInfo, specifiedType: _type);
  ...
  Future<Response<TunerHostInfo>> addTunerHost({ 
    ...
    try {
      ...
      _bodyData = tunerHostInfo == null ? null : _serializers.serialize(tunerHostInfo, specifiedType: _type);
  ...
  Future<Response<void>> cancelSeriesTimer({ 
    ...
    final _path = r'/LiveTv/SeriesTimers/{timerId}'.replaceAll('{' r'timerId' '}', encodeQueryParameter(_serializers, timerId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> cancelTimer({ 
    ...
    final _path = r'/LiveTv/Timers/{timerId}'.replaceAll('{' r'timerId' '}', encodeQueryParameter(_serializers, timerId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> createSeriesTimer({ 
    ...
    try {
      ...
      _bodyData = seriesTimerInfoDto == null ? null : _serializers.serialize(seriesTimerInfoDto, specifiedType: _type);
  ...
  Future<Response<void>> createTimer({ 
    ...
    try {
      ...
      _bodyData = timerInfoDto == null ? null : _serializers.serialize(timerInfoDto, specifiedType: _type);
  ...
  Future<Response<void>> deleteRecording({ 
    ...
    final _path = r'/LiveTv/Recordings/{recordingId}'.replaceAll('{' r'recordingId' '}', encodeQueryParameter(_serializers, recordingId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<TunerHostInfo>>> discoverTuners({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(TunerHostInfo)]),
  ...
  Future<Response<BaseItemDto>> getChannel({ 
    ...
    final _path = r'/LiveTv/Channels/{channelId}'.replaceAll('{' r'channelId' '}', encodeQueryParameter(_serializers, channelId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Uint8List>> getLiveRecordingFile({ 
    ...
    final _path = r'/LiveTv/LiveRecordings/{recordingId}/stream'.replaceAll('{' r'recordingId' '}', encodeQueryParameter(_serializers, recordingId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
  ...
  Future<Response<Uint8List>> getLiveStreamFile({ 
    ...
    final _path = r'/LiveTv/LiveStreamFiles/{streamId}/stream.{container}'.replaceAll('{' r'streamId' '}', encodeQueryParameter(_serializers, streamId, const FullType(String)).toString()).replaceAll('{' r'container' '}', encodeQueryParameter(_serializers, container, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<BaseItemDto>> getProgram({ 
    ...
    final _path = r'/LiveTv/Programs/{programId}'.replaceAll('{' r'programId' '}', encodeQueryParameter(_serializers, programId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseItemDtoQueryResult>> getPrograms({ 
    ...
    try {
      ...
      _bodyData = getProgramsDto == null ? null : _serializers.serialize(getProgramsDto, specifiedType: _type);
  ...
  Future<Response<void>> resetTuner({ 
    ...
    final _path = r'/LiveTv/Tuners/{tunerId}/Reset'.replaceAll('{' r'tunerId' '}', encodeQueryParameter(_serializers, tunerId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TunerChannelMapping>> setChannelMapping({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(setChannelMappingDto, specifiedType: _type);
