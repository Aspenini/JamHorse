...
class StartupApi {
  ...
  Future<Response<void>> completeWizard({ 
    ...
    final _path = r'/Startup/Complete';
  ...
  Future<Response<StartupUserDto>> getFirstUser2({ 
    ...
    final _path = r'/Startup/FirstUser';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<StartupConfigurationDto>> getStartupConfiguration({ 
    ...
    final _path = r'/Startup/Configuration';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> setRemoteAccess({ 
    ...
    final _path = r'/Startup/RemoteAccess';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(startupRemoteAccessDto, specifiedType: _type);
  ...
  Future<Response<void>> updateInitialConfiguration({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(startupConfigurationDto, specifiedType: _type);
  ...
  Future<Response<void>> updateStartupUser({ 
    ...
    try {
      ...
      _bodyData = startupUserDto == null ? null : _serializers.serialize(startupUserDto, specifiedType: _type);
