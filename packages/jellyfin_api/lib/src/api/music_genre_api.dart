...
class MusicGenreApi {
  ...
  const MusicGenreApi(this._dio, this._serializers);
  ...
  Future<Response<BaseItemDto>> getMusicGenre({ 
    ...
    final _path = r'/MusicGenres/{genreName}'.replaceAll('{' r'genreName' '}', encodeQueryParameter(_serializers, genreName, const FullType(String)).toString());
