...
class PlaylistApi {
  ...
  const PlaylistApi(this._dio, this._serializers);
  ...
  /// * [position] - Optional. 0-based index where to place the items or at the end if `null`.
  /// * [userId] - The userId.
  ...
  Future<Response<void>> addItemToPlaylist({ 
    ...
    final _path = r'/Playlists/{playlistId}/Items'.replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString());
  ...
  Future<Response<PlaylistCreationResult>> createPlaylist({ 
    ...
    try {
      ...
      _bodyData = createPlaylistDto == null ? null : _serializers.serialize(createPlaylistDto, specifiedType: _type);
  ...
  Future<Response<PlaylistDto>> getPlaylist({ 
    ...
    final _path = r'/Playlists/{playlistId}'.replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PlaylistDto),
      ) as PlaylistDto;
  ...
  Future<Response<PlaylistUserPermissions>> getPlaylistUser({ 
    ...
    final _path = r'/Playlists/{playlistId}/Users/{userId}'.replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString()).replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<PlaylistUserPermissions>>> getPlaylistUsers({ 
    ...
    final _path = r'/Playlists/{playlistId}/Users'.replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(PlaylistUserPermissions)]),
  ...
  Future<Response<void>> moveItem({ 
    ...
    final _path = r'/Playlists/{playlistId}/Items/{itemId}/Move/{newIndex}'.replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString()).replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'newIndex' '}', encodeQueryParameter(_serializers, newIndex, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> updatePlaylist({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updatePlaylistDto, specifiedType: _type);
  ...
  Future<Response<void>> updatePlaylistUser({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updatePlaylistUserDto, specifiedType: _type);
