...
class RemoteImageApi {
  ...
  Future<Response<void>> downloadRemoteImage({ 
    ...
    final _path = r'/Items/{itemId}/RemoteImages/Download'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  Future<Response<BuiltList<ImageProviderInfo>>> getRemoteImageProviders({ 
    ...
    final _path = r'/Items/{itemId}/RemoteImages/Providers'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RemoteImageResult>> getRemoteImages({ 
    ...
    final _path = r'/Items/{itemId}/RemoteImages'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
