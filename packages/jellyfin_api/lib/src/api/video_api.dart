...
class VideoApi {
  ...
  Future<Response<void>> deleteAlternateSources({ 
    ...
    final _path = r'/Videos/{itemId}/AlternateSources'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  Future<Response<BaseItemDtoQueryResult>> getAdditionalPart({ 
    ...
    final _path = r'/Videos/{itemId}/AdditionalParts'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Uint8List>> getAttachment({ 
    ...
    final _path = r'/Videos/{videoId}/{mediaSourceId}/Attachments/{index}'.replaceAll('{' r'videoId' '}', encodeQueryParameter(_serializers, videoId, const FullType(String)).toString()).replaceAll('{' r'mediaSourceId' '}', encodeQueryParameter(_serializers, mediaSourceId, const FullType(String)).toString()).replaceAll('{' r'index' '}', encodeQueryParameter(_serializers, index, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
  ...
  Future<Response<Uint8List>> getVideoStream({ 
    ...
    final _path = r'/Videos/{itemId}/stream'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (enableAudioVbrEncoding != null) r'enableAudioVbrEncoding': encodeQueryParameter(_serializers, enableAudioVbrEncoding, const FullType(bool)),
    };
  ...
  Future<Response<Uint8List>> getVideoStreamByContainer({ 
    ...
    final _path = r'/Videos/{itemId}/stream.{container}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'container' '}', encodeQueryParameter(_serializers, container, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
