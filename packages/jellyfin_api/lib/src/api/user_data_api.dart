...
class UserDataApi {
  ...
  Future<Response<UserItemDataDto>> deleteUserItemRating({ 
    ...
    final _path = r'/UserItems/{itemId}/Rating'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  Future<Response<UserItemDataDto>> getItemUserData({ 
    ...
    final _path = r'/UserItems/{itemId}/UserData'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserItemDataDto>> markFavoriteItem({ 
    ...
    final _path = r'/UserFavoriteItems/{itemId}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserItemDataDto>> markPlayedItem({ 
    ...
    final _path = r'/UserPlayedItems/{itemId}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserItemDataDto>> updateItemUserData({ 
    ...
    try {
      const _type = FullType(UpdateUserItemDataDto);
      _bodyData = _serializers.serialize(updateUserItemDataDto, specifiedType: _type);
