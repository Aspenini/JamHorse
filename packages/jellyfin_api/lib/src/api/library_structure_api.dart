...
class LibraryStructureApi {
  ...
  Future<Response<void>> addVirtualFolder({ 
    ...
    try {
      ...
      _bodyData = addVirtualFolderDto == null ? null : _serializers.serialize(addVirtualFolderDto, specifiedType: _type);
  ...
  Future<Response<void>> updateLibraryOptions({ 
    ...
    try {
      ...
      _bodyData = updateLibraryOptionsDto == null ? null : _serializers.serialize(updateLibraryOptionsDto, specifiedType: _type);
  ...
  Future<Response<void>> updateMediaPath({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateMediaPathRequestDto, specifiedType: _type);
