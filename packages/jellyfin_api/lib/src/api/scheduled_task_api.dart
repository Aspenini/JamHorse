...
class ScheduledTaskApi {
  ...
  const ScheduledTaskApi(this._dio, this._serializers);
  ...
  Future<Response<TaskInfo>> getTask({ 
    ...
    final _path = r'/ScheduledTasks/{taskId}'.replaceAll('{' r'taskId' '}', encodeQueryParameter(_serializers, taskId, const FullType(String)).toString());
  ...
  Future<Response<void>> startTask({ 
    ...
    final _path = r'/ScheduledTasks/Running/{taskId}'.replaceAll('{' r'taskId' '}', encodeQueryParameter(_serializers, taskId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> updateTask({ 
    ...
    final _path = r'/ScheduledTasks/{taskId}/Triggers'.replaceAll('{' r'taskId' '}', encodeQueryParameter(_serializers, taskId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
