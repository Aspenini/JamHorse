...
class AuthenticationApi {
  ...
  Future<Response<AuthenticationResult>> authenticateUserByName({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(authenticateUserByName, specifiedType: _type);
  ...
  Future<Response<PinRedeemResult>> forgotPasswordPin({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(forgotPasswordPinDto, specifiedType: _type);
  ...
  Future<Response<BuiltList<NameIdPair>>> getPasswordResetProviders({ 
    ...
    final _path = r'/Auth/PasswordResetProviders';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
