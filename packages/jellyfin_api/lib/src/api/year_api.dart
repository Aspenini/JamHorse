...
class YearApi {
  ...
  const YearApi(this._dio, this._serializers);
  ...
  Future<Response<BaseItemDto>> getYear({ 
    ...
    final _path = r'/Years/{year}'.replaceAll('{' r'year' '}', encodeQueryParameter(_serializers, year, const FullType(int)).toString());
