...
class InstantMixApi {
  ...
  Future<Response<BaseItemDtoQueryResult>> getInstantMixFromAlbum({ 
    ...
    final _path = r'/Albums/{itemId}/InstantMix'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  Future<Response<BaseItemDtoQueryResult>> getInstantMixFromArtists({ 
    ...
    final _path = r'/Artists/{itemId}/InstantMix'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseItemDtoQueryResult>> getInstantMixFromItem({ 
    ...
    final _path = r'/Items/{itemId}/InstantMix'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseItemDtoQueryResult>> getInstantMixFromMusicGenreByName({ 
    ...
    final _path = r'/MusicGenres/{name}/InstantMix'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseItemDtoQueryResult>> getInstantMixFromPlaylist({ 
    ...
    final _path = r'/Playlists/{itemId}/InstantMix'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseItemDtoQueryResult>> getInstantMixFromSong({ 
    ...
    final _path = r'/Songs/{itemId}/InstantMix'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
