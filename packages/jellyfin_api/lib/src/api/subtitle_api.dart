...
class SubtitleApi {
  ...
  Future<Response<void>> deleteSubtitle({ 
    ...
    final _path = r'/Videos/{itemId}/Subtitles/{index}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'index' '}', encodeQueryParameter(_serializers, index, const FullType(int)).toString());
  ...
  Future<Response<void>> downloadRemoteSubtitles({ 
    ...
    final _path = r'/Items/{itemId}/RemoteSearch/Subtitles/{subtitleId}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'subtitleId' '}', encodeQueryParameter(_serializers, subtitleId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Uint8List>> getFallbackFont({ 
    ...
    final _path = r'/FallbackFont/Fonts/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
  ...
  Future<Response<Uint8List>> getRemoteSubtitles({ 
    ...
    final _path = r'/Providers/Subtitles/Subtitles/{subtitleId}'.replaceAll('{' r'subtitleId' '}', encodeQueryParameter(_serializers, subtitleId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getSubtitle({ 
    ...
    final _path = r'/Videos/{routeItemId}/{routeMediaSourceId}/Subtitles/{routeIndex}/Stream.{routeFormat}'.replaceAll('{' r'routeItemId' '}', encodeQueryParameter(_serializers, routeItemId, const FullType(String)).toString()).replaceAll('{' r'routeMediaSourceId' '}', encodeQueryParameter(_serializers, routeMediaSourceId, const FullType(String)).toString()).replaceAll('{' r'routeIndex' '}', encodeQueryParameter(_serializers, routeIndex, const FullType(int)).toString()).replaceAll('{' r'routeFormat' '}', encodeQueryParameter(_serializers, routeFormat, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getSubtitlePlaylist({ 
    ...
    final _path = r'/Videos/{itemId}/{mediaSourceId}/Subtitles/{index}/subtitles.m3u8'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'index' '}', encodeQueryParameter(_serializers, index, const FullType(int)).toString()).replaceAll('{' r'mediaSourceId' '}', encodeQueryParameter(_serializers, mediaSourceId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getSubtitleWithTicks({ 
    ...
    final _path = r'/Videos/{routeItemId}/{routeMediaSourceId}/Subtitles/{routeIndex}/{routeStartPositionTicks}/Stream.{routeFormat}'.replaceAll('{' r'routeItemId' '}', encodeQueryParameter(_serializers, routeItemId, const FullType(String)).toString()).replaceAll('{' r'routeMediaSourceId' '}', encodeQueryParameter(_serializers, routeMediaSourceId, const FullType(String)).toString()).replaceAll('{' r'routeIndex' '}', encodeQueryParameter(_serializers, routeIndex, const FullType(int)).toString()).replaceAll('{' r'routeStartPositionTicks' '}', encodeQueryParameter(_serializers, routeStartPositionTicks, const FullType(int)).toString()).replaceAll('{' r'routeFormat' '}', encodeQueryParameter(_serializers, routeFormat, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<BuiltList<RemoteSubtitleInfo>>> searchRemoteSubtitles({ 
    ...
    final _path = r'/Items/{itemId}/RemoteSearch/Subtitles/{language}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'language' '}', encodeQueryParameter(_serializers, language, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> uploadSubtitle({ 
    ...
    final _path = r'/Videos/{itemId}/Subtitles'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(uploadSubtitleDto, specifiedType: _type);
