...
class ArtistApi {
  ...
  const ArtistApi(this._dio, this._serializers);
  ...
  Future<Response<BaseItemDto>> getArtistByName({ 
    ...
    final _path = r'/Artists/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
