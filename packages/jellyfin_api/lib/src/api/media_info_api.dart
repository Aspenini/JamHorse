...
class MediaInfoApi {
  ...
  Future<Response<PlaybackInfoResponse>> getPlaybackInfo({ 
    ...
    final _path = r'/Items/{itemId}/PlaybackInfo'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlaybackInfoResponse>> getPostedPlaybackInfo({ 
    ...
    try {
      ...
      _bodyData = playbackInfoDto == null ? null : _serializers.serialize(playbackInfoDto, specifiedType: _type);
  ...
  Future<Response<LiveStreamResponse>> openLiveStream({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (enableDirectPlay != null) r'enableDirectPlay': encodeQueryParameter(_serializers, enableDirectPlay, const FullType(bool)),
      if (enableDirectStream != null) r'enableDirectStream': encodeQueryParameter(_serializers, enableDirectStream, const FullType(bool)),
      if (alwaysBurnInSubtitleWhenTranscoding != null) r'alwaysBurnInSubtitleWhenTranscoding': encodeQueryParameter(_serializers, alwaysBurnInSubtitleWhenTranscoding, const FullType(bool)),
    };
    ...
    try {
      ...
      _bodyData = openLiveStreamDto == null ? null : _serializers.serialize(openLiveStreamDto, specifiedType: _type);
