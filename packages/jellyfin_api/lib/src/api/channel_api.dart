...
class ChannelApi {
  ...
  Future<Response<BuiltList<ChannelFeatures>>> getAllChannelFeatures({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ChannelFeatures)]),
  ...
  Future<Response<ChannelFeatures>> getChannelFeatures({ 
    ...
    final _path = r'/Channels/{channelId}/Features'.replaceAll('{' r'channelId' '}', encodeQueryParameter(_serializers, channelId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BaseItemDtoQueryResult>> getChannelItems({ 
    ...
    final _path = r'/Channels/{channelId}/Items'.replaceAll('{' r'channelId' '}', encodeQueryParameter(_serializers, channelId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
