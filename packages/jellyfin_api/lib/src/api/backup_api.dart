...
class BackupApi {
  ...
  Future<Response<BackupManifestDto>> createBackup({ 
    ...
    try {
      const _type = FullType(BackupOptionsDto);
      _bodyData = backupOptionsDto == null ? null : _serializers.serialize(backupOptionsDto, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BackupManifestDto),
      ) as BackupManifestDto;
    ...
    return Response<BackupManifestDto>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<BackupManifestDto>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BackupManifestDto>>> listBackups({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<BackupManifestDto>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(BackupManifestDto)]),
      ) as BuiltList<BackupManifestDto>;
    ...
    return Response<BuiltList<BackupManifestDto>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> startRestoreBackup({ 
    ...
    try {
      const _type = FullType(BackupRestoreRequestDto);
      _bodyData = _serializers.serialize(backupRestoreRequestDto, specifiedType: _type);
