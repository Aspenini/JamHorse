...
class SyncPlayApi {
  ...
  Future<Response<void>> syncPlayBuffering({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(bufferRequestDto, specifiedType: _type);
  ...
  Future<Response<GroupInfoDto>> syncPlayCreateGroup({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(newGroupRequestDto, specifiedType: _type);
  ...
  Future<Response<GroupInfoDto>> syncPlayGetGroup({ 
    ...
    final _path = r'/SyncPlay/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<GroupInfoDto>>> syncPlayGetGroups({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(GroupInfoDto)]),
  ...
  Future<Response<void>> syncPlayJoinGroup({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(joinGroupRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlayMovePlaylistItem({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(movePlaylistItemRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlayNextItem({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(nextItemRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlayPreviousItem({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(previousItemRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlayRemoveFromPlaylist({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(removeFromPlaylistRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlaySetIgnoreWait({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(ignoreWaitRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlaySetPlaylistItem({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(setPlaylistItemRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlaySetRepeatMode({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(setRepeatModeRequestDto, specifiedType: _type);
  ...
  Future<Response<void>> syncPlaySetShuffleMode({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(setShuffleModeRequestDto, specifiedType: _type);
