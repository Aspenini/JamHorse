...
class ShowApi {
  ...
  const ShowApi(this._dio, this._serializers);
  ...
  Future<Response<BaseItemDtoQueryResult>> getEpisodes({ 
    ...
    final _path = r'/Shows/{seriesId}/Episodes'.replaceAll('{' r'seriesId' '}', encodeQueryParameter(_serializers, seriesId, const FullType(String)).toString());
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (sortBy != null) r'sortBy': encodeQueryParameter(_serializers, sortBy, const FullType(ItemSortBy)),
    };
  ...
  Future<Response<BaseItemDtoQueryResult>> getNextUp({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (enableResumable != null) r'enableResumable': encodeQueryParameter(_serializers, enableResumable, const FullType(bool)),
  ...
  Future<Response<BaseItemDtoQueryResult>> getSeasons({ 
    ...
    final _path = r'/Shows/{seriesId}/Seasons'.replaceAll('{' r'seriesId' '}', encodeQueryParameter(_serializers, seriesId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
