...
class SystemApi {
  ...
  Future<Response<ActivityLogEntryQueryResult>> getLogEntries({ 
    ...
    String? username,
    LogLevel? severity,
    BuiltList<ActivityLogSortBy>? sortBy,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (maxDate != null) r'maxDate': encodeQueryParameter(_serializers, maxDate, const FullType(DateTime)),
      if (hasUserId != null) r'hasUserId': encodeQueryParameter(_serializers, hasUserId, const FullType(bool)),
      if (name != null) r'name': encodeQueryParameter(_serializers, name, const FullType(String)),
      if (overview != null) r'overview': encodeQueryParameter(_serializers, overview, const FullType(String)),
      if (shortOverview != null) r'shortOverview': encodeQueryParameter(_serializers, shortOverview, const FullType(String)),
      ...
      if (severity != null) r'severity': encodeQueryParameter(_serializers, severity, const FullType(LogLevel)),
      if (sortBy != null) r'sortBy': encodeCollectionQueryParameter<ActivityLogSortBy>(_serializers, sortBy, const FullType(BuiltList, [FullType(ActivityLogSortBy)]), format: ListFormat.multi,),
  ...
  Future<Response<void>> updateBrandingConfiguration({ 
    ...
    try {
      const _type = FullType(BrandingOptionsDto);
      _bodyData = _serializers.serialize(brandingOptionsDto, specifiedType: _type);
  ...
  Future<Response<void>> updateConfiguration({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(serverConfiguration, specifiedType: _type);
