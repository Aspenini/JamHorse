...
class AudioApi {
  ...
  Future<Response<Uint8List>> getAudioStream({ 
    ...
    final _path = r'/Audio/{itemId}/stream'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  Future<Response<Uint8List>> getAudioStreamByContainer({ 
    ...
    final _path = r'/Audio/{itemId}/stream.{container}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'container' '}', encodeQueryParameter(_serializers, container, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getUniversalAudioStream({ 
    ...
    final _path = r'/Audio/{itemId}/universal'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (transcodingProtocol != null) r'transcodingProtocol': encodeQueryParameter(_serializers, transcodingProtocol, const FullType(MediaStreamProtocol)),
