...
class TrailerApi {
  ...
  const TrailerApi(this._dio, this._serializers);
  ...
  /// * [subtitleLanguages] - Optional. If specified, results will be filtered based on subtitale language. This allows multiple, comma delimited values.
