...
class UserViewApi {
  ...
  const UserViewApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<SpecialViewOptionDto>>> getGroupingOptions({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(SpecialViewOptionDto)]),
  ...
  Future<Response<BaseItemDtoQueryResult>> getUserViews({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (presetViews != null) r'presetViews': encodeCollectionQueryParameter<CollectionType>(_serializers, presetViews, const FullType(BuiltList, [FullType(CollectionType)]), format: ListFormat.multi,),
