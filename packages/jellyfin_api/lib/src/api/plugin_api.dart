...
class PluginApi {
  ...
  Future<Response<void>> cancelPackageInstallation({ 
    ...
    final _path = r'/Packages/Installing/{packageId}'.replaceAll('{' r'packageId' '}', encodeQueryParameter(_serializers, packageId, const FullType(String)).toString());
  ...
  Future<Response<void>> disablePlugin({ 
    ...
    final _path = r'/Plugins/{pluginId}/{version}/Disable'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> enablePlugin({ 
    ...
    final _path = r'/Plugins/{pluginId}/{version}/Enable'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ConfigurationPageInfo>>> getConfigurationPages({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ConfigurationPageInfo)]),
  ...
  Future<Response<PackageInfo>> getPackageInfo({ 
    ...
    final _path = r'/Packages/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> getPluginConfiguration({ 
    ...
    final _path = r'/Plugins/{pluginId}/Configuration'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Uint8List>> getPluginImage({ 
    ...
    final _path = r'/Plugins/{pluginId}/{version}/Image'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<void>> getPluginManifest({ 
    ...
    final _path = r'/Plugins/{pluginId}/Manifest'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> installPackage({ 
    ...
    final _path = r'/Packages/Installed/{name}'.replaceAll('{' r'name' '}', encodeQueryParameter(_serializers, name, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> uninstallPlugin({ 
    ...
    final _path = r'/Plugins/{pluginId}'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> uninstallPluginByVersion({ 
    ...
    final _path = r'/Plugins/{pluginId}/{version}'.replaceAll('{' r'pluginId' '}', encodeQueryParameter(_serializers, pluginId, const FullType(String)).toString()).replaceAll('{' r'version' '}', encodeQueryParameter(_serializers, version, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
