...
class UserApi {
  ...
  Future<Response<UserDto>> createUserByName({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createUserByName, specifiedType: _type);
  ...
  Future<Response<void>> deleteUser({ 
    ...
    final _path = r'/Users/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> updateUserConfiguration({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(userConfiguration, specifiedType: _type);
  ...
  Future<Response<void>> updateUserPassword({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateUserPassword, specifiedType: _type);
  ...
  Future<Response<void>> updateUserPolicy({ 
    ...
    final _path = r'/Users/{userId}/Policy'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
