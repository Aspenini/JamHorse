...
class SessionApi {
  ...
  Future<Response<void>> addUserToSession({ 
    ...
    final _path = r'/Sessions/{sessionId}/User/{userId}'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString()).replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
  ...
  Future<Response<void>> displayContent({ 
    ...
    final _path = r'/Sessions/{sessionId}/Viewing'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<SessionInfoDto>>> getSessions({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(SessionInfoDto)]),
  ...
  Future<Response<void>> play({ 
    ...
    final _path = r'/Sessions/{sessionId}/Playing'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> postCapabilities({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (playableMediaTypes != null) r'playableMediaTypes': encodeCollectionQueryParameter<MediaType>(_serializers, playableMediaTypes, const FullType(BuiltList, [FullType(MediaType)]), format: ListFormat.multi,),
  ...
  Future<Response<void>> postFullCapabilities({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(clientCapabilitiesDto, specifiedType: _type);
  ...
  Future<Response<void>> reportPlaybackProgress({ 
    ...
    try {
      ...
      _bodyData = playbackProgressInfo == null ? null : _serializers.serialize(playbackProgressInfo, specifiedType: _type);
  ...
  Future<Response<void>> reportPlaybackStart({ 
    ...
    try {
      ...
      _bodyData = playbackStartInfo == null ? null : _serializers.serialize(playbackStartInfo, specifiedType: _type);
  ...
  Future<Response<void>> reportPlaybackStopped({ 
    ...
    try {
      ...
      _bodyData = playbackStopInfo == null ? null : _serializers.serialize(playbackStopInfo, specifiedType: _type);
  ...
  Future<Response<void>> reportViewing({ 
    ...
    final _path = r'/Sessions/Viewing';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> sendFullGeneralCommand({ 
    ...
    final _path = r'/Sessions/{sessionId}/Command'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> sendGeneralCommand({ 
    ...
    final _path = r'/Sessions/{sessionId}/Command/{command}'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString()).replaceAll('{' r'command' '}', encodeQueryParameter(_serializers, command, const FullType(GeneralCommandType)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> sendMessageCommand({ 
    ...
    final _path = r'/Sessions/{sessionId}/Message'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> sendPlaystateCommand({ 
    ...
    final _path = r'/Sessions/{sessionId}/Playing/{command}'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString()).replaceAll('{' r'command' '}', encodeQueryParameter(_serializers, command, const FullType(PlaystateCommand)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> sendSystemCommand({ 
    ...
    final _path = r'/Sessions/{sessionId}/System/{command}'.replaceAll('{' r'sessionId' '}', encodeQueryParameter(_serializers, sessionId, const FullType(String)).toString()).replaceAll('{' r'command' '}', encodeQueryParameter(_serializers, command, const FullType(GeneralCommandType)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
