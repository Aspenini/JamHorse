...
class ItemLookupApi {
  ...
  Future<Response<void>> applySearchCriteria({ 
    ...
    final _path = r'/Items/RemoteSearch/Apply/{itemId}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    ...
    try {
      ...
      _bodyData = _serializers.serialize(remoteSearchResult, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getBookRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(bookInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getBoxSetRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(boxSetInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<ExternalIdInfo>>> getExternalIdInfos({ 
    ...
    final _path = r'/Items/{itemId}/ExternalIdInfos'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getMovieRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(movieInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getMusicAlbumRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(albumInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getMusicArtistRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(artistInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getMusicVideoRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(musicVideoInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getPersonRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(personLookupInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getSeriesRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(seriesInfoRemoteSearchQuery, specifiedType: _type);
  ...
  Future<Response<BuiltList<RemoteSearchResult>>> getTrailerRemoteSearchResults({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(trailerInfoRemoteSearchQuery, specifiedType: _type);
