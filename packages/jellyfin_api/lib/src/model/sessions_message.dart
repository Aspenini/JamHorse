...
@BuiltValue()
abstract class SessionsMessage implements Built<SessionsMessage, SessionsMessageBuilder> {
  ...
  factory SessionsMessage([void updates(SessionsMessageBuilder b)]) = _$SessionsMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SessionsMessageBuilder b) => b
      ..messageType = 'Sessions';

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionsMessage> get serializer => _$SessionsMessageSerializer();
}

class _$SessionsMessageSerializer implements PrimitiveSerializer<SessionsMessage> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.data != null) {
      ...
      yield serializers.serialize(
        object.data,
        specifiedType: const FullType.nullable(BuiltList, [FullType(SessionInfoDto)]),
      );
    }
