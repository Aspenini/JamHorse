...
@BuiltValue()
abstract class RefreshProgressMessage implements Built<RefreshProgressMessage, RefreshProgressMessageBuilder> {
  ...
  factory RefreshProgressMessage([void updates(RefreshProgressMessageBuilder b)]) = _$RefreshProgressMessage;
  ...
  static Serializer<RefreshProgressMessage> get serializer => _$RefreshProgressMessageSerializer();
}

class _$RefreshProgressMessageSerializer implements PrimitiveSerializer<RefreshProgressMessage> {
  @override
  final Iterable<Type> types = const [RefreshProgressMessage, _$RefreshProgressMessage];
