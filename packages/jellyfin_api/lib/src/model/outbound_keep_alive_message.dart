...
@BuiltValue()
abstract class OutboundKeepAliveMessage implements Built<OutboundKeepAliveMessage, OutboundKeepAliveMessageBuilder> {
  ...
  factory OutboundKeepAliveMessage([void updates(OutboundKeepAliveMessageBuilder b)]) = _$OutboundKeepAliveMessage;
  ...
  static Serializer<OutboundKeepAliveMessage> get serializer => _$OutboundKeepAliveMessageSerializer();
}

class _$OutboundKeepAliveMessageSerializer implements PrimitiveSerializer<OutboundKeepAliveMessage> {
  @override
  final Iterable<Type> types = const [OutboundKeepAliveMessage, _$OutboundKeepAliveMessage];
