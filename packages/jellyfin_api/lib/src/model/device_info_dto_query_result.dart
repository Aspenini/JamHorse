...
@BuiltValue()
abstract class DeviceInfoDtoQueryResult implements Built<DeviceInfoDtoQueryResult, DeviceInfoDtoQueryResultBuilder> {
  ...
  factory DeviceInfoDtoQueryResult([void updates(DeviceInfoDtoQueryResultBuilder b)]) = _$DeviceInfoDtoQueryResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeviceInfoDtoQueryResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeviceInfoDtoQueryResult> get serializer => _$DeviceInfoDtoQueryResultSerializer();
}

class _$DeviceInfoDtoQueryResultSerializer implements PrimitiveSerializer<DeviceInfoDtoQueryResult> {
  @override
  final Iterable<Type> types = const [DeviceInfoDtoQueryResult, _$DeviceInfoDtoQueryResult];
