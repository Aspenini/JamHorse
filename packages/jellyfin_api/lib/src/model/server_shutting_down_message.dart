...
@BuiltValue()
abstract class ServerShuttingDownMessage implements Built<ServerShuttingDownMessage, ServerShuttingDownMessageBuilder> {
  ...
  factory ServerShuttingDownMessage([void updates(ServerShuttingDownMessageBuilder b)]) = _$ServerShuttingDownMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ServerShuttingDownMessageBuilder b) => b
      ..messageType = 'ServerShuttingDown';

  @BuiltValueSerializer(custom: true)
  static Serializer<ServerShuttingDownMessage> get serializer => _$ServerShuttingDownMessageSerializer();
}

class _$ServerShuttingDownMessageSerializer implements PrimitiveSerializer<ServerShuttingDownMessage> {
  @override
  final Iterable<Type> types = const [ServerShuttingDownMessage, _$ServerShuttingDownMessage];
