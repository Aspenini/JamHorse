...
@BuiltValue()
abstract class ActivityLogEntryStopMessage implements Built<ActivityLogEntryStopMessage, ActivityLogEntryStopMessageBuilder> {
  ...
  factory ActivityLogEntryStopMessage([void updates(ActivityLogEntryStopMessageBuilder b)]) = _$ActivityLogEntryStopMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ActivityLogEntryStopMessageBuilder b) => b
      ..messageType = 'ActivityLogEntryStop';

  @BuiltValueSerializer(custom: true)
  static Serializer<ActivityLogEntryStopMessage> get serializer => _$ActivityLogEntryStopMessageSerializer();
}

class _$ActivityLogEntryStopMessageSerializer implements PrimitiveSerializer<ActivityLogEntryStopMessage> {
  @override
  final Iterable<Type> types = const [ActivityLogEntryStopMessage, _$ActivityLogEntryStopMessage];
