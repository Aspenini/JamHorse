...
@BuiltValue()
abstract class ScheduledTaskEndedMessage implements Built<ScheduledTaskEndedMessage, ScheduledTaskEndedMessageBuilder> {
  ...
  factory ScheduledTaskEndedMessage([void updates(ScheduledTaskEndedMessageBuilder b)]) = _$ScheduledTaskEndedMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ScheduledTaskEndedMessageBuilder b) => b
      ..messageType = 'ScheduledTaskEnded';

  @BuiltValueSerializer(custom: true)
  static Serializer<ScheduledTaskEndedMessage> get serializer => _$ScheduledTaskEndedMessageSerializer();
}

class _$ScheduledTaskEndedMessageSerializer implements PrimitiveSerializer<ScheduledTaskEndedMessage> {
  @override
  final Iterable<Type> types = const [ScheduledTaskEndedMessage, _$ScheduledTaskEndedMessage];
