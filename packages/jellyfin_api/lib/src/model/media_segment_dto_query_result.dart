...
@BuiltValue()
abstract class MediaSegmentDtoQueryResult implements Built<MediaSegmentDtoQueryResult, MediaSegmentDtoQueryResultBuilder> {
  ...
  factory MediaSegmentDtoQueryResult([void updates(MediaSegmentDtoQueryResultBuilder b)]) = _$MediaSegmentDtoQueryResult;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MediaSegmentDtoQueryResultBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MediaSegmentDtoQueryResult> get serializer => _$MediaSegmentDtoQueryResultSerializer();
}

class _$MediaSegmentDtoQueryResultSerializer implements PrimitiveSerializer<MediaSegmentDtoQueryResult> {
  @override
  final Iterable<Type> types = const [MediaSegmentDtoQueryResult, _$MediaSegmentDtoQueryResult];
