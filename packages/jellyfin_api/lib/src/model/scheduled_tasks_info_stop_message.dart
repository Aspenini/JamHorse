...
@BuiltValue()
abstract class ScheduledTasksInfoStopMessage implements Built<ScheduledTasksInfoStopMessage, ScheduledTasksInfoStopMessageBuilder> {
  ...
  factory ScheduledTasksInfoStopMessage([void updates(ScheduledTasksInfoStopMessageBuilder b)]) = _$ScheduledTasksInfoStopMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ScheduledTasksInfoStopMessageBuilder b) => b
      ..messageType = 'ScheduledTasksInfoStop';

  @BuiltValueSerializer(custom: true)
  static Serializer<ScheduledTasksInfoStopMessage> get serializer => _$ScheduledTasksInfoStopMessageSerializer();
}

class _$ScheduledTasksInfoStopMessageSerializer implements PrimitiveSerializer<ScheduledTasksInfoStopMessage> {
  @override
  final Iterable<Type> types = const [ScheduledTasksInfoStopMessage, _$ScheduledTasksInfoStopMessage];
