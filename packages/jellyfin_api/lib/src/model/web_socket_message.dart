...
abstract class WebSocketMessage implements Built<WebSocketMessage, WebSocketMessageBuilder> {
  ...
  factory WebSocketMessage([void updates(WebSocketMessageBuilder b)]) = _$WebSocketMessage;
...
class _$WebSocketMessageSerializer implements PrimitiveSerializer<WebSocketMessage> {
  @override
