...
@BuiltValue()
abstract class GeneralCommandMessage implements Built<GeneralCommandMessage, GeneralCommandMessageBuilder> {
  ...
  factory GeneralCommandMessage([void updates(GeneralCommandMessageBuilder b)]) = _$GeneralCommandMessage;
  ...
  static Serializer<GeneralCommandMessage> get serializer => _$GeneralCommandMessageSerializer();
}

class _$GeneralCommandMessageSerializer implements PrimitiveSerializer<GeneralCommandMessage> {
  @override
  final Iterable<Type> types = const [GeneralCommandMessage, _$GeneralCommandMessage];
