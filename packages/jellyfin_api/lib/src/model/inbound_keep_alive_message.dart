...
@BuiltValue()
abstract class InboundKeepAliveMessage implements Built<InboundKeepAliveMessage, InboundKeepAliveMessageBuilder> {
  ...
  factory InboundKeepAliveMessage([void updates(InboundKeepAliveMessageBuilder b)]) = _$InboundKeepAliveMessage;
  ...
  static Serializer<InboundKeepAliveMessage> get serializer => _$InboundKeepAliveMessageSerializer();
}

class _$InboundKeepAliveMessageSerializer implements PrimitiveSerializer<InboundKeepAliveMessage> {
  @override
  final Iterable<Type> types = const [InboundKeepAliveMessage, _$InboundKeepAliveMessage];
