...
abstract class GetProgramsDto implements Built<GetProgramsDto, GetProgramsDtoBuilder> {
  ...
  factory GetProgramsDto([void updates(GetProgramsDtoBuilder b)]) = _$GetProgramsDto;
...
class _$GetProgramsDtoSerializer implements PrimitiveSerializer<GetProgramsDto> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.sortBy != null) {
      ...
      yield serializers.serialize(
        object.sortBy,
        specifiedType: const FullType.nullable(BuiltList, [FullType(ItemSortBy)]),
      );
    }
    if (object.sortOrder != null) {
      ...
      yield serializers.serialize(
        object.sortOrder,
        specifiedType: const FullType.nullable(BuiltList, [FullType(SortOrder)]),
      );
    }
    ...
    if (object.fields != null) {
      ...
      yield serializers.serialize(
        object.fields,
        specifiedType: const FullType.nullable(BuiltList, [FullType(ItemFields)]),
      );
    }
  }
