...
@BuiltValue()
abstract class PlaystateMessage implements Built<PlaystateMessage, PlaystateMessageBuilder> {
  ...
  factory PlaystateMessage([void updates(PlaystateMessageBuilder b)]) = _$PlaystateMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PlaystateMessageBuilder b) => b
      ..messageType = 'Playstate';

  @BuiltValueSerializer(custom: true)
  static Serializer<PlaystateMessage> get serializer => _$PlaystateMessageSerializer();
}

class _$PlaystateMessageSerializer implements PrimitiveSerializer<PlaystateMessage> {
  @override
