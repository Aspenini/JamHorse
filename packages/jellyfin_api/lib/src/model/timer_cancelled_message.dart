...
@BuiltValue()
abstract class TimerCancelledMessage implements Built<TimerCancelledMessage, TimerCancelledMessageBuilder> {
  ...
  factory TimerCancelledMessage([void updates(TimerCancelledMessageBuilder b)]) = _$TimerCancelledMessage;
  ...
  static Serializer<TimerCancelledMessage> get serializer => _$TimerCancelledMessageSerializer();
}

class _$TimerCancelledMessageSerializer implements PrimitiveSerializer<TimerCancelledMessage> {
  @override
  final Iterable<Type> types = const [TimerCancelledMessage, _$TimerCancelledMessage];
