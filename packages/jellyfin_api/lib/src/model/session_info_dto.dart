...
@BuiltValue()
abstract class SessionInfoDto implements Built<SessionInfoDto, SessionInfoDtoBuilder> {
  ...
  factory SessionInfoDto([void updates(SessionInfoDtoBuilder b)]) = _$SessionInfoDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SessionInfoDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionInfoDto> get serializer => _$SessionInfoDtoSerializer();
}

class _$SessionInfoDtoSerializer implements PrimitiveSerializer<SessionInfoDto> {
  @override
