...
@BuiltValue()
abstract class SeriesTimerCreatedMessage implements Built<SeriesTimerCreatedMessage, SeriesTimerCreatedMessageBuilder> {
  ...
  factory SeriesTimerCreatedMessage([void updates(SeriesTimerCreatedMessageBuilder b)]) = _$SeriesTimerCreatedMessage;
  ...
  static Serializer<SeriesTimerCreatedMessage> get serializer => _$SeriesTimerCreatedMessageSerializer();
}

class _$SeriesTimerCreatedMessageSerializer implements PrimitiveSerializer<SeriesTimerCreatedMessage> {
  @override
  final Iterable<Type> types = const [SeriesTimerCreatedMessage, _$SeriesTimerCreatedMessage];
