...
@BuiltValue()
abstract class ScheduledTasksInfoStartMessage implements Built<ScheduledTasksInfoStartMessage, ScheduledTasksInfoStartMessageBuilder> {
  ...
  factory ScheduledTasksInfoStartMessage([void updates(ScheduledTasksInfoStartMessageBuilder b)]) = _$ScheduledTasksInfoStartMessage;
  ...
  static Serializer<ScheduledTasksInfoStartMessage> get serializer => _$ScheduledTasksInfoStartMessageSerializer();
}

class _$ScheduledTasksInfoStartMessageSerializer implements PrimitiveSerializer<ScheduledTasksInfoStartMessage> {
  @override
  final Iterable<Type> types = const [ScheduledTasksInfoStartMessage, _$ScheduledTasksInfoStartMessage];
