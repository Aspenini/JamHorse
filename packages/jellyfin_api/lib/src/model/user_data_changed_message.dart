...
@BuiltValue()
abstract class UserDataChangedMessage implements Built<UserDataChangedMessage, UserDataChangedMessageBuilder> {
  ...
  factory UserDataChangedMessage([void updates(UserDataChangedMessageBuilder b)]) = _$UserDataChangedMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserDataChangedMessageBuilder b) => b
      ..messageType = 'UserDataChanged';

  @BuiltValueSerializer(custom: true)
  static Serializer<UserDataChangedMessage> get serializer => _$UserDataChangedMessageSerializer();
}

class _$UserDataChangedMessageSerializer implements PrimitiveSerializer<UserDataChangedMessage> {
  @override
  final Iterable<Type> types = const [UserDataChangedMessage, _$UserDataChangedMessage];
