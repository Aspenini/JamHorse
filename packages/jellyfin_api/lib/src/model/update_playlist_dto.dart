...
@BuiltValue()
abstract class UpdatePlaylistDto implements Built<UpdatePlaylistDto, UpdatePlaylistDtoBuilder> {
  ...
  factory UpdatePlaylistDto([void updates(UpdatePlaylistDtoBuilder b)]) = _$UpdatePlaylistDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdatePlaylistDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdatePlaylistDto> get serializer => _$UpdatePlaylistDtoSerializer();
}

class _$UpdatePlaylistDtoSerializer implements PrimitiveSerializer<UpdatePlaylistDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.users != null) {
      ...
      yield serializers.serialize(
        object.users,
        specifiedType: const FullType.nullable(BuiltList, [FullType(PlaylistUserPermissions)]),
      );
    }
