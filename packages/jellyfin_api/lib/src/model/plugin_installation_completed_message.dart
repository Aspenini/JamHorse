...
@BuiltValue()
abstract class PluginInstallationCompletedMessage implements Built<PluginInstallationCompletedMessage, PluginInstallationCompletedMessageBuilder> {
  ...
  factory PluginInstallationCompletedMessage([void updates(PluginInstallationCompletedMessageBuilder b)]) = _$PluginInstallationCompletedMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PluginInstallationCompletedMessageBuilder b) => b
      ..messageType = 'PackageInstallationCompleted';

  @BuiltValueSerializer(custom: true)
  static Serializer<PluginInstallationCompletedMessage> get serializer => _$PluginInstallationCompletedMessageSerializer();
}

class _$PluginInstallationCompletedMessageSerializer implements PrimitiveSerializer<PluginInstallationCompletedMessage> {
  @override
  final Iterable<Type> types = const [PluginInstallationCompletedMessage, _$PluginInstallationCompletedMessage];
