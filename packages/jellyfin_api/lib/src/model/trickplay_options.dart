...
@BuiltValue()
abstract class TrickplayOptions implements Built<TrickplayOptions, TrickplayOptionsBuilder> {
  ...
  factory TrickplayOptions([void updates(TrickplayOptionsBuilder b)]) = _$TrickplayOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TrickplayOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TrickplayOptions> get serializer => _$TrickplayOptionsSerializer();
}

class _$TrickplayOptionsSerializer implements PrimitiveSerializer<TrickplayOptions> {
  @override
