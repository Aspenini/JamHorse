...
@BuiltValue()
abstract class ServerRestartingMessage implements Built<ServerRestartingMessage, ServerRestartingMessageBuilder> {
  ...
  factory ServerRestartingMessage([void updates(ServerRestartingMessageBuilder b)]) = _$ServerRestartingMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ServerRestartingMessageBuilder b) => b
      ..messageType = 'ServerRestarting';

  @BuiltValueSerializer(custom: true)
  static Serializer<ServerRestartingMessage> get serializer => _$ServerRestartingMessageSerializer();
}

class _$ServerRestartingMessageSerializer implements PrimitiveSerializer<ServerRestartingMessage> {
  @override
  final Iterable<Type> types = const [ServerRestartingMessage, _$ServerRestartingMessage];
