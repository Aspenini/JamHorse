...
@BuiltValue()
abstract class ActivityLogEntryStartMessage implements Built<ActivityLogEntryStartMessage, ActivityLogEntryStartMessageBuilder> {
  ...
  factory ActivityLogEntryStartMessage([void updates(ActivityLogEntryStartMessageBuilder b)]) = _$ActivityLogEntryStartMessage;
  ...
  static Serializer<ActivityLogEntryStartMessage> get serializer => _$ActivityLogEntryStartMessageSerializer();
}

class _$ActivityLogEntryStartMessageSerializer implements PrimitiveSerializer<ActivityLogEntryStartMessage> {
  @override
  final Iterable<Type> types = const [ActivityLogEntryStartMessage, _$ActivityLogEntryStartMessage];
