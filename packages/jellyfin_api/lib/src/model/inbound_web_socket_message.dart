...
@BuiltValue()
abstract class InboundWebSocketMessage implements Built<InboundWebSocketMessage, InboundWebSocketMessageBuilder> {
  ...
  factory InboundWebSocketMessage([void updates(InboundWebSocketMessageBuilder b)]) = _$InboundWebSocketMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InboundWebSocketMessageBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<InboundWebSocketMessage> get serializer => _$InboundWebSocketMessageSerializer();
}
...
extension InboundWebSocketMessageBuilderDiscriminatorExt on InboundWebSocketMessageBuilder {
    String? get discriminatorValue {
...
class _$InboundWebSocketMessageSerializer implements PrimitiveSerializer<InboundWebSocketMessage> {
  @override
  final Iterable<Type> types = const [InboundWebSocketMessage, _$InboundWebSocketMessage];
  ...
  InboundWebSocketMessage deserialize(
    ...
    final discIndex = serializedList.indexOf(InboundWebSocketMessage.discriminatorFieldName) + 1;
    final discValue = serializers.deserialize(serializedList[discIndex], specifiedType: FullType(String)) as String;
    oneOfDataSrc = serialized;
    final oneOfTypes = [ActivityLogEntryStartMessage, ActivityLogEntryStopMessage, InboundKeepAliveMessage, ScheduledTasksInfoStartMessage, ScheduledTasksInfoStopMessage, SessionsStartMessage, SessionsStopMessage, ];
    Object oneOfResult;
    Type oneOfType;
    switch (discValue) {
