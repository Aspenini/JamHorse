...
@BuiltValue()
abstract class CastReceiverApplication implements Built<CastReceiverApplication, CastReceiverApplicationBuilder> {
  ...
  factory CastReceiverApplication([void updates(CastReceiverApplicationBuilder b)]) = _$CastReceiverApplication;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CastReceiverApplicationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CastReceiverApplication> get serializer => _$CastReceiverApplicationSerializer();
}

class _$CastReceiverApplicationSerializer implements PrimitiveSerializer<CastReceiverApplication> {
  @override
  final Iterable<Type> types = const [CastReceiverApplication, _$CastReceiverApplication];
