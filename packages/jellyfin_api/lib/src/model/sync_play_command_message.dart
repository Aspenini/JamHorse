...
@BuiltValue()
abstract class SyncPlayCommandMessage implements Built<SyncPlayCommandMessage, SyncPlayCommandMessageBuilder> {
  /// Class SendCommand.
  ...
  factory SyncPlayCommandMessage([void updates(SyncPlayCommandMessageBuilder b)]) = _$SyncPlayCommandMessage;
  ...
  static Serializer<SyncPlayCommandMessage> get serializer => _$SyncPlayCommandMessageSerializer();
}

class _$SyncPlayCommandMessageSerializer implements PrimitiveSerializer<SyncPlayCommandMessage> {
  @override
  final Iterable<Type> types = const [SyncPlayCommandMessage, _$SyncPlayCommandMessage];
