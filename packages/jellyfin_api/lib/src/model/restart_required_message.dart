...
@BuiltValue()
abstract class RestartRequiredMessage implements Built<RestartRequiredMessage, RestartRequiredMessageBuilder> {
  ...
  factory RestartRequiredMessage([void updates(RestartRequiredMessageBuilder b)]) = _$RestartRequiredMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RestartRequiredMessageBuilder b) => b
      ..messageType = 'RestartRequired';

  @BuiltValueSerializer(custom: true)
  static Serializer<RestartRequiredMessage> get serializer => _$RestartRequiredMessageSerializer();
}

class _$RestartRequiredMessageSerializer implements PrimitiveSerializer<RestartRequiredMessage> {
  @override
  final Iterable<Type> types = const [RestartRequiredMessage, _$RestartRequiredMessage];
