...
@BuiltValue()
abstract class SessionsStopMessage implements Built<SessionsStopMessage, SessionsStopMessageBuilder> {
  ...
  factory SessionsStopMessage([void updates(SessionsStopMessageBuilder b)]) = _$SessionsStopMessage;
  ...
  static Serializer<SessionsStopMessage> get serializer => _$SessionsStopMessageSerializer();
}

class _$SessionsStopMessageSerializer implements PrimitiveSerializer<SessionsStopMessage> {
  @override
  final Iterable<Type> types = const [SessionsStopMessage, _$SessionsStopMessage];
