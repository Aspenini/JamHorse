...
abstract class OutboundWebSocketMessage implements Built<OutboundWebSocketMessage, OutboundWebSocketMessageBuilder> {
  ...
  OutboundWebSocketMessage._();

  factory OutboundWebSocketMessage([void updates(OutboundWebSocketMessageBuilder b)]) = _$OutboundWebSocketMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OutboundWebSocketMessageBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OutboundWebSocketMessage> get serializer => _$OutboundWebSocketMessageSerializer();
}

extension OutboundWebSocketMessageDiscriminatorExt on OutboundWebSocketMessage {
...
extension OutboundWebSocketMessageBuilderDiscriminatorExt on OutboundWebSocketMessageBuilder {
    String? get discriminatorValue {
...
class _$OutboundWebSocketMessageSerializer implements PrimitiveSerializer<OutboundWebSocketMessage> {
  @override
  final Iterable<Type> types = const [OutboundWebSocketMessage, _$OutboundWebSocketMessage];

  @override
  final String wireName = r'OutboundWebSocketMessage';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OutboundWebSocketMessage object, {
  ...
  @override
  OutboundWebSocketMessage deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OutboundWebSocketMessageBuilder();
    Object? oneOfDataSrc;
    final serializedList = (serialized as Iterable<Object?>).toList();
    final discIndex = serializedList.indexOf(OutboundWebSocketMessage.discriminatorFieldName) + 1;
    final discValue = serializers.deserialize(serializedList[discIndex], specifiedType: FullType(String)) as String;
    oneOfDataSrc = serialized;
    final oneOfTypes = [ActivityLogEntryMessage, ForceKeepAliveMessage, GeneralCommandMessage, OutboundKeepAliveMessage, LibraryChangedMessage, PluginInstallationCancelledMessage, PluginInstallationCompletedMessage, PluginInstallationFailedMessage, PluginInstallingMessage, PluginUninstalledMessage, PlayMessage, PlaystateMessage, RefreshProgressMessage, RestartRequiredMessage, ScheduledTaskEndedMessage, ScheduledTasksInfoMessage, SeriesTimerCancelledMessage, SeriesTimerCreatedMessage, ServerRestartingMessage, ServerShuttingDownMessage, SessionsMessage, SyncPlayCommandMessage, SyncPlayGroupUpdateMessage, TimerCancelledMessage, TimerCreatedMessage, UserDataChangedMessage, UserDeletedMessage, UserUpdatedMessage, ];
    Object oneOfResult;
    Type oneOfType;
    switch (discValue) {
