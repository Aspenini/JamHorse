...
@BuiltValue()
abstract class RemoteLyricInfoDto implements Built<RemoteLyricInfoDto, RemoteLyricInfoDtoBuilder> {
  ...
  factory RemoteLyricInfoDto([void updates(RemoteLyricInfoDtoBuilder b)]) = _$RemoteLyricInfoDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RemoteLyricInfoDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RemoteLyricInfoDto> get serializer => _$RemoteLyricInfoDtoSerializer();
}

class _$RemoteLyricInfoDtoSerializer implements PrimitiveSerializer<RemoteLyricInfoDto> {
  @override
