...
@BuiltValue()
abstract class ScheduledTasksInfoMessage implements Built<ScheduledTasksInfoMessage, ScheduledTasksInfoMessageBuilder> {
  ...
  factory ScheduledTasksInfoMessage([void updates(ScheduledTasksInfoMessageBuilder b)]) = _$ScheduledTasksInfoMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ScheduledTasksInfoMessageBuilder b) => b
      ..messageType = 'ScheduledTasksInfo';

  @BuiltValueSerializer(custom: true)
  static Serializer<ScheduledTasksInfoMessage> get serializer => _$ScheduledTasksInfoMessageSerializer();
}

class _$ScheduledTasksInfoMessageSerializer implements PrimitiveSerializer<ScheduledTasksInfoMessage> {
  @override
  final Iterable<Type> types = const [ScheduledTasksInfoMessage, _$ScheduledTasksInfoMessage];
