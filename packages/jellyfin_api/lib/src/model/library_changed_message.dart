...
@BuiltValue()
abstract class LibraryChangedMessage implements Built<LibraryChangedMessage, LibraryChangedMessageBuilder> {
  ...
  factory LibraryChangedMessage([void updates(LibraryChangedMessageBuilder b)]) = _$LibraryChangedMessage;
  ...
  static Serializer<LibraryChangedMessage> get serializer => _$LibraryChangedMessageSerializer();
}

class _$LibraryChangedMessageSerializer implements PrimitiveSerializer<LibraryChangedMessage> {
  @override
  final Iterable<Type> types = const [LibraryChangedMessage, _$LibraryChangedMessage];
