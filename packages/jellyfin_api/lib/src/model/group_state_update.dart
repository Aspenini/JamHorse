...
@BuiltValue()
abstract class GroupStateUpdate implements Built<GroupStateUpdate, GroupStateUpdateBuilder> {
  ...
  factory GroupStateUpdate([void updates(GroupStateUpdateBuilder b)]) = _$GroupStateUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GroupStateUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GroupStateUpdate> get serializer => _$GroupStateUpdateSerializer();
}

class _$GroupStateUpdateSerializer implements PrimitiveSerializer<GroupStateUpdate> {
  @override
