...
@BuiltValue()
abstract class SeriesTimerCancelledMessage implements Built<SeriesTimerCancelledMessage, SeriesTimerCancelledMessageBuilder> {
  ...
  factory SeriesTimerCancelledMessage([void updates(SeriesTimerCancelledMessageBuilder b)]) = _$SeriesTimerCancelledMessage;
  ...
  static Serializer<SeriesTimerCancelledMessage> get serializer => _$SeriesTimerCancelledMessageSerializer();
}

class _$SeriesTimerCancelledMessageSerializer implements PrimitiveSerializer<SeriesTimerCancelledMessage> {
  @override
  final Iterable<Type> types = const [SeriesTimerCancelledMessage, _$SeriesTimerCancelledMessage];
