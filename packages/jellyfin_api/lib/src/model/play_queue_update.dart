...
@BuiltValue()
abstract class PlayQueueUpdate implements Built<PlayQueueUpdate, PlayQueueUpdateBuilder> {
  ...
  factory PlayQueueUpdate([void updates(PlayQueueUpdateBuilder b)]) = _$PlayQueueUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PlayQueueUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlayQueueUpdate> get serializer => _$PlayQueueUpdateSerializer();
}

class _$PlayQueueUpdateSerializer implements PrimitiveSerializer<PlayQueueUpdate> {
  @override
