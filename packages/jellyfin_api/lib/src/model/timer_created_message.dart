...
@BuiltValue()
abstract class TimerCreatedMessage implements Built<TimerCreatedMessage, TimerCreatedMessageBuilder> {
  ...
  factory TimerCreatedMessage([void updates(TimerCreatedMessageBuilder b)]) = _$TimerCreatedMessage;
  ...
  static Serializer<TimerCreatedMessage> get serializer => _$TimerCreatedMessageSerializer();
}

class _$TimerCreatedMessageSerializer implements PrimitiveSerializer<TimerCreatedMessage> {
  @override
  final Iterable<Type> types = const [TimerCreatedMessage, _$TimerCreatedMessage];
