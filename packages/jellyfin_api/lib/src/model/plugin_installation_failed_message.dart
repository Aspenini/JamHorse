...
@BuiltValue()
abstract class PluginInstallationFailedMessage implements Built<PluginInstallationFailedMessage, PluginInstallationFailedMessageBuilder> {
  ...
  factory PluginInstallationFailedMessage([void updates(PluginInstallationFailedMessageBuilder b)]) = _$PluginInstallationFailedMessage;
  ...
  static Serializer<PluginInstallationFailedMessage> get serializer => _$PluginInstallationFailedMessageSerializer();
}

class _$PluginInstallationFailedMessageSerializer implements PrimitiveSerializer<PluginInstallationFailedMessage> {
  @override
  final Iterable<Type> types = const [PluginInstallationFailedMessage, _$PluginInstallationFailedMessage];
