...
@BuiltValue()
abstract class DeviceInfoDto implements Built<DeviceInfoDto, DeviceInfoDtoBuilder> {
  ...
  factory DeviceInfoDto([void updates(DeviceInfoDtoBuilder b)]) = _$DeviceInfoDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DeviceInfoDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DeviceInfoDto> get serializer => _$DeviceInfoDtoSerializer();
}
