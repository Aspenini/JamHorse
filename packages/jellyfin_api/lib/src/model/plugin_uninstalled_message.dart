...
@BuiltValue()
abstract class PluginUninstalledMessage implements Built<PluginUninstalledMessage, PluginUninstalledMessageBuilder> {
  ...
  factory PluginUninstalledMessage([void updates(PluginUninstalledMessageBuilder b)]) = _$PluginUninstalledMessage;
  ...
  static Serializer<PluginUninstalledMessage> get serializer => _$PluginUninstalledMessageSerializer();
}

class _$PluginUninstalledMessageSerializer implements PrimitiveSerializer<PluginUninstalledMessage> {
  @override
  final Iterable<Type> types = const [PluginUninstalledMessage, _$PluginUninstalledMessage];
