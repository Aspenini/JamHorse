...
/// * [type] - Defines the types of content an individual Jellyfin.Database.Implementations.Entities.MediaSegment represents.
/// * [startTicks] - Gets or sets the start of the segment.
/// * [endTicks] - Gets or sets the end of the segment.
@BuiltValue()
abstract class MediaSegmentDto implements Built<MediaSegmentDto, MediaSegmentDtoBuilder> {
  ...
  factory MediaSegmentDto([void updates(MediaSegmentDtoBuilder b)]) = _$MediaSegmentDto;
  ...
  static Serializer<MediaSegmentDto> get serializer => _$MediaSegmentDtoSerializer();
}

class _$MediaSegmentDtoSerializer implements PrimitiveSerializer<MediaSegmentDto> {
  @override
