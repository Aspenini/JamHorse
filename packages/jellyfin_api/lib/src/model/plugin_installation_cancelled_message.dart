...
@BuiltValue()
abstract class PluginInstallationCancelledMessage implements Built<PluginInstallationCancelledMessage, PluginInstallationCancelledMessageBuilder> {
  ...
  factory PluginInstallationCancelledMessage([void updates(PluginInstallationCancelledMessageBuilder b)]) = _$PluginInstallationCancelledMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PluginInstallationCancelledMessageBuilder b) => b
      ..messageType = 'PackageInstallationCancelled';

  @BuiltValueSerializer(custom: true)
  static Serializer<PluginInstallationCancelledMessage> get serializer => _$PluginInstallationCancelledMessageSerializer();
}

class _$PluginInstallationCancelledMessageSerializer implements PrimitiveSerializer<PluginInstallationCancelledMessage> {
  @override
  final Iterable<Type> types = const [PluginInstallationCancelledMessage, _$PluginInstallationCancelledMessage];
